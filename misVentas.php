...
<body class="d-flex flex-column min-vh-100 bg-secondary.bg-gradient" style="margin-top: 3.5em;">
    ...
    <div class="container mt-5 mb-5">
        <div class="container mt-5 mb-5 boxContainer">
            ...
            <div class="row">
                <div class="col">
                    <label for="selectRangoFecha" class="form-label">Rango de creación del curso</label>
                ...
                <div class="col">
                    <label for="selectRangoFecha" class="form-label">Categoría</label>
                    <select class="form-select" aria-label="Default select example" id="selectRangoFecha">
        ...
        <div class="container mt-5 mb-5 boxContainer">
            <div class="col card mb-3">
                <a href="./misVentasDetalle.php?curso=1" class="nav-link text-muted">
                    <div class="row g-0">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <p class="card-text"><small class="text-body-secondary">Total inscritos: 1</small></p>
                                    </div>
                                    <div class="col">
                                        <p class="card-text"><small class="text-body-secondary">Promedio de niveles cursados: 1</small></p>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <p class="card-text"><small class="text-body-secondary">Total de ingresos: 1.00 $</small></p>
                                    </div>
                                    <div class="col">
                                        <p class="card-text"><small class="text-body-secondary">
                                                <ul>
                                                    <li>MetodoPago1: 123.00 $</li>
                                                    <li>MetodoPago2: 123.00 $</li>
                                                    <li>MetodoPago3: 123.00 $</li>
                                                </ul>
                                            </small></p>
                                    </div>
                                </div>
