...
<body class="d-flex flex-column min-vh-100 bg-secondary.bg-gradient" style="margin-top: 3.5em;">
    ...
    <div class="container mt-5 mb-5">
        <div class="container mt-5 mb-5 boxContainer">
            <legend class="text-center">Detalle</legend>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text">Datos del alumno.</p>
                            <div class="row">
                                <div class="col">
                                    <p class="card-text"><small class="text-body-secondary">Fecha de inscripción: 01/01/2000</small></p>
                                </div>
                                <div class="col">
                                    <p class="card-text"><small class="text-body-secondary">Nivel de avance: 1</small></p>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="card-text"><small class="text-body-secondary">Ingresos del curso: 123.00 $</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
